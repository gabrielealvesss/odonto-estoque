    ...
    <head>
        ...
        <script type="text/javascript">
            function confirmarExclusao(id, nome) {
                if (confirm('Deseja realmente deletar o Perfil ' + nome + '?')) {
            ...
            <table class="table table-hover table-striped table-bordered display"
                ...
                <tbody>
                    <c:forEach var="p" items="${listaPerfil}">
                        ...
                        <tr>
                            <td style="display: none;">${p.idPerfil}</td>
                            <td>${p.nome}</td>
                            <td> <c:choose>
                            ...
                            <td>
                                ...
                                <a href="gerenciar_perfil_menu.do?acao=gerenciar&idPerfil=${p.idPerfil}" class="btn btn-default">
